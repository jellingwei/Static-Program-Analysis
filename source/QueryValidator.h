...
public:
	...
	BOOLEAN_ validatePatternQueries(Synonym arg0, Synonym arg1, Synonym arg2, Synonym arg3);//Validates all pattern queries based on relationship table initialised. 
...
protected:
	...
	std::tr1::unordered_map<SYNONYM_TYPE, vector<SYNONYM_TYPE>> patternsArg3Map; //maps the relationship to its type of argument 2
